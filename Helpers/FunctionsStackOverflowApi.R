...
{
	install.packages("httr", dependencies = TRUE, lib = libPath)
}
if ("xml2" %in% installed.packages()==FALSE)
{
	install.packages("xml2", dependencies = TRUE, lib = libPath)
}
if ("urltools" %in% installed.packages()==FALSE)
{
	install.packages("urltools", dependencies = TRUE, lib = libPath)
}
if ("jsonlite" %in% installed.packages()==FALSE)
{
	install.packages("jsonlite", dependencies = TRUE, lib = libPath)
}
if ("anytime" %in% installed.packages()==FALSE)
{
	install.packages("anytime", dependencies = TRUE, lib = libPath)
}
library(httr)
library(xml2)
library(urltools)
...
api_key = 'eNpdWEIsDlE8Kcf3YhSEiw(('
