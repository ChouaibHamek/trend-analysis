setwd ('C:\\Users\\sehossei\\Desktop\\ET\\TrendMining-master')
...
get_ScopusData = function(app_path, query_string, my_filename){
  ...
  my_file = paste(my_file, "my_scopus_", sep="", collapse=" ")
...
data = get_ScopusData(app_path, query_string, my_filename)
